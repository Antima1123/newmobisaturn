export const stdCodes = [
    ...
    { value: "+242", label: "+242 (Congo, Republic of the)" },
    { value: "+243", label: "+243 (Congo, Democratic Republic of the)" },
    ...
    { value: "+1", label: "+1 (Trinidad and Tobago)" },
    { value: "+216", label: "+216 (Tunisia)" },
    { value: "+90", label: "+90 (Turkey)" },
    { value: "+993", label: "+993 (Turkmenistan)" },
    { value: "+1", label: "+1 (Turks and Caicos Islands)" },
    ...
    { value: "+39", label: "+39 (Vatican City)" },
